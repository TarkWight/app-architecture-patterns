...
inline constexpr const char *unavailableSelectedTelemetryConfigLog = "Выбранный файл телеметрии недоступен: ";
inline constexpr const char *telemetryConfigUnavailableTitle = "Файл телеметрии недоступен";
inline constexpr const char *telemetryConfigUnavailableMessage =
    "Выбранный файл телеметрии недоступен. Выберите существующий файл.";
inline constexpr const char *telemetryConfigNotFoundLog = "Файл телеметрии не найден: ";
inline constexpr const char *telemetryConfigNotFoundTitle = "Файл телеметрии не найден";
inline constexpr const char *telemetryConfigNotFoundMessage =
    "Файл телеметрии не найден рядом с приложением. Создайте шаблон и заполните параметры подключения стенда или "
...
inline constexpr const char *createTelemetryTemplateDialogTitle = "Создать файл телеметрии";
inline constexpr const char *selectTelemetryConfigDialogTitle = "Выбрать файл телеметрии";
...
inline constexpr const char *telemetryConfigSelectedLog = "Выбран файл телеметрии: ";
...
inline constexpr const char *loadTomlButton = "Загрузить файл конфигурации";
inline constexpr const char *loadTomlTooltip = "Подгрузить значения полей из файла конфигурации";
inline constexpr const char *saveTomlTemplateButton = "Создать шаблон конфигурации";
inline constexpr const char *saveTomlTemplateTooltip = "Сохранить пустой шаблон для полей протокола";
...
inline constexpr const char *loadPdfTomlDialogTitle = "Загрузить данные PDF из файла конфигурации";
inline constexpr const char *createPdfTomlTemplateDialogTitle = "Создать файл конфигурации шаблона PDF";
